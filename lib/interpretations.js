...
psychology: [
  ...
  aspect.aspect === "Square"
    ? `Address tensions involving ${aspect.natalPlanet.toLowerCase()}`
    : aspect.aspect === "Trine"
    ? `Take advantage of natural opportunities`
    : aspect.aspect === "Sextile"
    ? `Say yes to constructive opportunities`
    : aspect.aspect === "Opposition"
    ? `Seek balance instead of extremes`
    : `Lean into this new cycle consciously`,
  ...(house?.advice || []),
  ...(status?.advice || [])
],
